...
class ConfigEncoder(json.JSONEncoder):
    def default(self, o):
        ...
        elif isinstance(o, enumerate):
            return {'$enum': o.__module__ + '.' + o.__class__.__name__}
        elif callable(o):
...
class Logger(object):
    def __init__(self, args, log_dir, **kwargs):
        ...
        self.tb_logger = SummaryWriter(logdir=osp.join(log_dir, 'tflogger'), **kwargs)
    ...
    def log_config(self, variant_data):
        ...
        with open(config_filepath, 'wt') as fd:
            json.dump(variant_data, fd, indent=2, sort_keys=True, cls=ConfigEncoder)

    def dump(self):
        with open(self.logger_path, 'wt') as fd:
